...
def choose_nation(REGIONS_ON_WINDOW):
    ...
    button_choose_nation = browser.find_flashing_image('button_choose_nation.png', region=REGIONS_ON_WINDOW['center_down'])
    if button_choose_nation:
        logging.info('''1.1 scroll nation right''')
        button_right_arrow_to_choose_nation = browser.find_flashing_image('right_arrow_to_choose_nation.png',
        ...
        if button_right_arrow_to_choose_nation:
            for i in range(10):
                time.sleep(2)
                usa_nation = browser.find_image('USA_nation.png', region=REGIONS_ON_WINDOW['center_down'])
        ...
        time.sleep(5)
        button_left_arrow_to_choose_nation = browser.find_flashing_image('left_arrow_to_choose_nation.png',
...
def first_battle(REGIONS_ON_WINDOW, REGIONS_ON_FULL_SCREEN):
    ...
    if browser.find_flashing_image('button_to_battle.png', region=REGIONS_ON_FULL_SCREEN['center_up']):
...
def quest_4(REGIONS_ON_FULL_SCREEN):
    ...
    if browser.find_flashing_image('help_arrow_right.png',
        ...
        pyautogui.moveTo(5, 5, 1)
        '''find button_helth'''
        button_helth = browser.find_flashing_image('button_helth.png', region=REGIONS_ON_FULL_SCREEN['right_mid'])
        if button_helth:
            ...
            help_arrow_right = browser.find_flashing_image('help_arrow_right.png', region=REGIONS_ON_FULL_SCREEN['right_mid'])
            if help_arrow_right:
                logging.info('way 2.2.1')
                browser.click_to_center(help_arrow_right, righter_on=50)

                time.sleep(1)
                help_arrow_down = browser.find_flashing_image('help_arrow_down.png', region=REGIONS_ON_FULL_SCREEN['center_mid'])
                if help_arrow_down:
    ...
    if quest_4_7_icon:
        ...
        help_arrow_down = browser.find_flashing_image('help_arrow_down.png', region=REGIONS_ON_FULL_SCREEN['center_down_menu'])
        if help_arrow_down:
